"""
Django settings for Eduthon project.
...
SECRET_KEY = 'u2xo$y3)i6p0!%)a!093ebf+_qaop-%p&i*-02dbiu7+6ts@uf'
...
WSGI_APPLICATION = 'Eduthon.wsgi.application'
